...
BOT_USERNAME = getenv("BOT_USERNAME" , "TaitanXMusic_Bot")
BOT_NAME = getenv("BOT_NAME" , "˹sᴏɴᴧʟɪ ꭙ ᴍᴜsɪᴄ˼ ♪ [ ᴛᴘʙ ]™")
ASSUSERNAME = getenv("ASSUSERNAME" , "TAITAN")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/RAUSHAN-SONALI-143/SONALI_NEWW",)
